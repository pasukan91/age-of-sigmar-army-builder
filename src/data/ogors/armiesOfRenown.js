...
const armiesOfRenown = [
  {
    ...
    rules: {
      battleTraits: [
        ...
        rule("the-unstoppable-feast", "The Unstoppable Feast", "Once Per Turn (Army)", "Your Charge Phase", "Pick a friendly Meatfist unit that has not used a Fight ability this battle. For the rest of the turn, it can use Charge abilities even if it used a Run or Retreat ability earlier in the same turn."),
  ...
  },
  {
    ...
    rules: {
      battleTraits: [
        ...
        rule("run-em-down", "Run 'Em Down", "Passive", null, "Each time an enemy unit in combat with a friendly Alfrostun unit uses a Retreat ability, after that ability has been resolved, inflict D3 mortal damage on that enemy unit."),
      ...
      artefacts: [trait("alvagr-rune-tokens", "Alvagr Rune-tokens", "Once per battle in your hero phase, until the start of your next turn, add 2 to chanting rolls for friendly Alfrostun units while they are wholly within 12\" of this unit.")],
      spellLores: [],
      prayerLores: [{
        id: "alfrostun-prayers", name: "Alfrostun Prayers", prayers: [
          { id: "keening-gale", name: "Keening Gale", type: "Prayer", chantingValue: 3, phase: "Your Hero Phase", keywords: ["Prayer", "Unlimited"], description: "A friendly Alfrostun unit wholly within 12\" gains +2 to run rolls; on a 6+, also +2 to charge rolls until your next turn." },
  ...
  },
  {
    ...
    rules: {
      battleTraits: [
        ...
        rule("bone-slurry-soup", "Bone-slurry Soup", "Once Per Turn (Army)", "Any Shooting Phase", "Spend 5 raw ingredients. Heal (D6) each friendly Gollop unit wholly within 12\" of and visible to a friendly Feastmaster."),
      ],
      ...
      spellLores: [{
        id: "gollop-spells", name: "Mawseeker Gollop Spells", spells: [
          ...
          { id: "bloodgruel", name: "Bloodgruel", type: "Spell", castingValue: 7, phase: "Your Hero Phase", keywords: ["Spell"], description: "Pick a friendly Gollop unit wholly within 12\". Return 1 slain model to the target or Heal (D6) the target." },
          { id: "the-cosmos-writhes", name: "The Cosmos Writhes", type: "Spell", castingValue: 6, phase: "Your Hero Phase", keywords: ["Spell"], description: "Remove a visible friendly Gollop unit wholly within 12\" from the battlefield and set it up again more than 9\" from all enemy units." },
        ],
      }],
