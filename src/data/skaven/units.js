...
const units = [
  ...
  ...[
    ...
    },
    {
      ...
      move: '6"', health: 5, save: "5+", base: "32mm", imageAlias: "ratling-warpblaster",
      weapons: [
    ...
    },
    {
      ...
      move: '6"', health: 5, save: "5+", base: "32mm", imageAlias: "spearhead-skaven",
      weapons: [
    ...
    },
    {
      ...
      move: '6"', health: 5, save: "6+", base: "32mm", imageAlias: "rat-ogors",
      weapons: [
  ...
  ...[
    ...
    { id: "acolyte-globadiers", name: "Acolyte Globadiers", points: 90, models: 5, move: '6"', health: 1, control: 1, save: "6+", base: "28.5mm", clans: ["Skryre", "Infantry", "Weapon Team", "Champion"], weapons: [weapon("Poisoned Wind Globes", "Ranged", 1, "3+", "3+", "1", "D3", ["Anti-Infantry (+1 Rend)", "Shoot in Combat"], '10"'), weapon("Rusty Knife", "Melee", 1, "4+", "5+", "0", "1")], abilityName: "Gas Clouds", abilityPhase: null, abilityType: "Passive", abilityText: "Add 1 Damage against enemy units with 10 or more models.", extraAbilities: [ability("Hidden Weapon Team", null, "Not visible beyond 13\" while sheltered by a Clanrats unit with 5 or more models and no other Weapon Team shares that combat range.", "Passive")], imageAlias: "ratling-warpblaster" },
    ...
    { id: "stormvermin", name: "Stormvermin", points: 110, models: 10, move: '6"', health: 1, control: 1, save: "4+", base: "28.5mm", clans: ["Verminus", "Infantry", "Champion", "Musician (1/10)", "Standard Bearer (1/10)"], weapons: [weapon("Stormvermin Weapons", "Melee", 3, "3+", "4+", "1", "1", ["Anti-Charge (+1 Rend)"])], abilityName: "Elite Bodyguard", abilityText: "Friendly Skaven Infantry Heroes have Ward (5+) while within this unit's combat range.", imageAlias: "krittok-foulblade" },
    ...
    { id: "night-runners", name: "Night Runners", points: 130, models: 10, move: '7"', health: 1, control: 1, save: "6+", base: "28.5mm", clans: ["Eshin", "Infantry", "Champion"], weapons: [weapon("Slings and Poisoned Stars", "Ranged", 2, "4+", "4+", "0", "1", ["Crit (Auto-wound)", "Shoot in Combat"], '10"'), weapon("Poisoned Blades", "Melee", 2, "4+", "5+", "0", "1", ["Crit (Mortal)"])], abilityName: "Slinking Advance", abilityPhase: "Deployment Phase", abilityText: "This unit can use a Normal Move ability as if it were your movement phase.", extraAbilities: [ability("Sneaky Infiltrators", null, "While every model is within 1\" of terrain, this unit cannot be targeted by shooting attacks unless the attacker is within 9\".", "Passive")], reinforce: false, imageAlias: "gutter-runners" },
