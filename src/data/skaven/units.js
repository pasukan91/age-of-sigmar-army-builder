...
const units = [
  ...
  ...[
    ...
    { id: "clawlord", name: "Clawlord", points: 70, clan: "Verminus", options: ["any-verminus"], move: '6"', health: 5, save: "4+", base: "32mm", signature: "Gnash-gnaw on Their Bones!", desc: "After this unit fights, a nearby non-Hero Verminus Infantry unit can fight immediately. If it is picked to do so, add 1 to hit rolls for the target's attacks for the rest of the turn." },
  ...
  ...[
    { id: "stormfiends", name: "Stormfiends", points: 230, models: 3, move: '6"', health: 6, control: 2, save: "4+", base: "60mm", clans: ["Skryre", "Moulder", "Infantry"], weapons: [weapon("Ratling Cannons", "Ranged", "3D6", "4+", "3+", "1", "1", [], '15"'), weapon("Doomflayer Gauntlets", "Melee", 5, "4+", "2+", "2", "2", ["Charge (+1 Damage)"])], abilityName: "Grinderfist Tunnellers", abilityPhase: "Any Movement Phase", abilityType: "Once Per Turn (Army)", abilityText: "If armed with Grinderfists and in the tunnels below, set this unit up more than 9\" from enemies." },
    ...
    { id: "brood-terror", name: "Brood Terror", points: 220, models: 1, move: '8"', health: 14, control: 5, save: "4+", base: "90mm", clans: ["Moulder", "Monster"], weapons: [weapon("Warpflame Scourger", "Ranged", "2D6", "4+", "3+", "2", "1", ["Anti-Infantry (+1 Rend)"], '15"'), weapon("Chain-flail", "Melee", 5, "3+", "2+", "2", "3", ["Crit (Mortal)"])], abilityName: "Regenerating Terror", abilityText: "At the end of any turn, Heal (D6) this unit.", extraAbilities: [ability("Lend a Claw", "Any Combat Phase", "Add 1 to hit rolls for the targets' attacks for the rest of the phase, including those made with Companion weapons.", "Ability")] },
