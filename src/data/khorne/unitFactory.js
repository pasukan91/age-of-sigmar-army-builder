...
export const ability = (name, phase, description, type = "Ability", keywords = []) => ({
  name, phase, type, description, keywords, castingValue: null, chantingValue: null, lore: null,
});

export function createUnit({
  id, name, points, models = 1, move = '5"', health = 1, control = 1,
  save = "5+", ward = null, baseSize = null, keywords = [], weapons = [],
  ...
  return {
    ...
    image: `/images/units/blades/${imageAlias ?? id.replaceAll("-", "_")}.jpg`,
    points, profile: { move, health, control, save, ward }, weapons, abilities,
    heroicTrait: null, monstrousTrait: null, artefact: null, brazenMutation: null,
    details: { models, baseSize, regimentOptions, canJoinRegimentAs, notes },
    keywords: [...keywords, "Chaos", "Blades of Khorne"], rules: unitRules,
  };
}
