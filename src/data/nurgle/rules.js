...
export const battleFormations = [
  { id: "tallyband-of-nurgle", name: "Tallyband of Nurgle", description: "Nominate a plague progenitor.", ability: rule("plague-progenitor", "Plague Progenitor", "Deployment Phase", "Once per battle, pick an enemy plague progenitor and roll 2D3. On a 6, or if the roll equals or exceeds its Health, it is Diseased. In the first battle round, if an ability would heal or return slain models to a Diseased plague progenitor, that ability does not heal any damage points or return slain models to it. When Spread targets it, also inflict D3 mortal damage on each other enemy in its combat range.", "Once Per Battle (Army)") },
