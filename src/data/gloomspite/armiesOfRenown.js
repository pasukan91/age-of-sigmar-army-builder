...
const armiesOfRenown = [
  {
    ...
    rules: {
      ...
      heroicTraits: [
        heroicTrait("stick-em-and-run", "Stick 'Em and Run", "Each time this unit Retreats or uses Careening Destruction, on a 2+ inflict D3 mortal damage on an enemy in combat."),
  ...
  },
  {
    ...
    rules: {
      ...
      battleTraits: [
        rule("the-moon-and-the-loon", "The Moon and the Loon", "Passive", null, "Within 9\" of Skragrott or a Loonshrine, non-Squig Moonclan units gain +5 control and Squig units can use Move 4 instead of rolling."),
      ...
      heroicTraits: [
        ...
        heroicTrait("da-kings-adjutant", "Da King's Adjutant", "Once per battle at the end of your turn, replace a destroyed eligible unit near a Bad Moon Loonshrine."),
      ...
      artefacts: [
        heroicTrait("moonhoned-shiv", "Moonhoned Shiv", "Add 1 Attack to a non-Companion melee weapon in deployment and each time this unit Retreats."),
      ...
      spellLores: [{
        ...
        spells: [
          { id: "da-loonkings-command", name: "Da Loonking's Command", castingValue: 5, keywords: ["Unlimited"], description: "A friendly unit within 18\" improves its champions' melee Attacks, Rally rolls and control until your next turn." },
          { id: "right-gitz-in-da-right-place", name: "Right Gitz in da Right Place", castingValue: 6, description: "A visible friendly unit within 18\" gains Anti-Hero (+1 Rend) until your next turn." },
        ],
      }],
      manifestationLores: [{
        id: "da-kings-moon",
