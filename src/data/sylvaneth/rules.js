...
export const spellLores = [{
  ...
  spells: [
    ...
    { id: "grasping-roots", name: "Grasping Roots", castingValue: 5, type: "Spell", phase: "Your Hero Phase", keywords: ["Spell"], description: "Declare: Pick a friendly SYLVANETH WIZARD to cast this spell, pick a visible enemy unit within 18\" of them to be the target, then make a casting roll of 2D6.\n\nEffect: The target cannot use Run abilities and subtract 1 from its charge rolls until your next turn." },
  ],
}];
...
export const prayerLores = [{
  ...
  prayers: [
    { id: "song-of-the-lost", name: "Song of the Lost", chantingValue: 4, type: "Prayer", phase: "Your Hero Phase", keywords: ["Prayer", "Unlimited"], description: "Pick a friendly unit wholly within the creeping overgrowth or visible and wholly within 12\". Until the start of your next turn, subtract 1 from wound rolls for attacks that target it. If the chanting roll was 8+, pick 1: Heal (3) the target; or, if the target is not a Monster, ignore positive and negative modifiers to its save rolls until the start of your next turn." },
