...
export const manifestations = [
  ...
  },
  {
    ...
    summonSpell: {
      ...
      castingValue: 5,
      keywords: ["Spell", "Summon"],
      description: "Declare: If there is not a friendly Gork-Roara on the battlefield, pick an eligible friendly WIZARD to cast this spell, then make a casting roll of 2D6.\n\nEffect: Set up a Gork-Roara wholly within 12\" of the caster, visible to them and more than 9\" from all enemy units.",
    },
  ...
  },
  {
    ...
    summonSpell: {
      ...
      castingValue: 5,
      keywords: ["Spell", "Summon"],
      description: "Declare: If there is not a friendly Morkspit Marsh on the battlefield, pick an eligible friendly WIZARD to cast this spell, then make a casting roll of 2D6.\n\nEffect: Set up a Morkspit Marsh wholly within 18\" of the caster and visible to them.",
    },
    details: { models: 1, baseSize: null },
    keywords: ["Manifestation", "Endless Spell", "Ward (6+)", "Destruction", "Ironjawz", "Kruleboyz"],
  },
