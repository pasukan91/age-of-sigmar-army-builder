...
const units = [
  createUnit({ id:"urak-taar", name:"Urak Taar", points:340, move:'10"', health:16, control:5, save:"3+", baseSize:"130mm", imageAlias:"urak_taar",
  ...
  createUnit({ id:"daemonsmith", name:"Daemonsmith", points:80, health:6, control:2, save:"4+", baseSize:"32mm", keywords:["Hero","Wizard (1)","Infantry","Duardin"], regimentOptions:["0-1 Hashutite Commander","Any Helsmiths of Hashut"],
    weapons:[weapon("Hurled Daemonfire","Ranged",3,"4+","4+",1,"D3",["Crit (2 Hits)"],'18"'),weapon("Darkiron Talon","Melee",3,"3+","4+",1,"D3")],
  ...
  createUnit({ id:"war-despot", name:"War Despot", points:80, health:6, control:2, save:"3+", baseSize:"32mm", imageAlias:"daemonsmith", keywords:["Hero","Infantry","Duardin"], regimentOptions:["Any Helsmiths of Hashut"], canJoinRegimentAs:["hashutite-commander"],
    weapons:[weapon("Daemonflame Glaive","Melee",5,"3+","3+",1,2,["Crit (Mortal)"])],
    abilities:[ability("Black-hearted Conqueror","Passive","+3 Control a Infantry Helsmiths of Hashut amigas totalmente a 6\"; +6\" de alcance por DPP."),ability("Fight, You Scum!","Any Combat Phase","Tras luchar, una Infantry Helsmiths of Hashut amiga no Hero dentro de su alcance de combate lucha inmediatamente y obtiene +1 Ataques de combate este turno.","Reaction")], rules:{hero:true,canBeReinforced:false} }),
  ...
  createUnit({ id:"dominator-engine-immolation-cannons", name:"Dominator Engine with Immolation Cannons", points:160, move:'6"', health:10, control:2, save:"2+", baseSize:"80mm", imageAlias:"dominator_engine", keywords:["War Machine","Automaton"],
  ...
  createUnit({ id:"razers-blunderbusses", name:"Razers with Blunderbusses", points:110, models:5, health:1, save:"4+", baseSize:"28.5mm", imageAlias:"infernal_razers", keywords:["Infantry","Champion","Duardin"],
  ...
  createUnit({ id:"razers-flamehurlers", name:"Razers with Flamehurlers", points:90, models:5, health:1, save:"4+", baseSize:"28.5mm", imageAlias:"infernal_razers", keywords:["Infantry","Champion","Duardin"],
  ...
  createUnit({ id:"infernal-cohort-blades", name:"Infernal Cohort with Blades", points:90, models:10, health:1, save:"3+", baseSize:"28.5mm", imageAlias:"infernal_cohort", keywords:["Infantry","Champion","Musician (1/10)","Duardin"],
  ...
  createUnit({ id:"infernal-cohort-spears", name:"Infernal Cohort with Spears", points:90, models:10, health:1, save:"3+", baseSize:"28.5mm", imageAlias:"infernal_cohort", keywords:["Infantry","Champion","Musician (1/10)","Duardin"],
