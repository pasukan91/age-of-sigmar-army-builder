...
export default [
  {
    ...
    prayerLores:[
      ...
      {id:"lava-storm",name:"Lava Storm",chantingValue:5,phase:"Your Hero Phase",description:"CV 5. Elige un enemigo visible a 18\". Inflige D3 mortales al objetivo; con un cántico de 7+, elige un segundo enemigo y causa D3 mortales a cada objetivo."},
    ],
  },
  {
    ...
    battleTraits:[
      ...
      trait("run-roughshod","Run Roughshod","Your Movement Phase","Elige una unidad Ziggurat Stampede amiga en combate. Este turno puede usar Shoot y/o Charge aunque use Retreat, y no sufre daño mortal por retirarse.","Once Per Turn (Army)"),
    ],
    ...
    spellLores:[
      ...
      {id:"burn-to-ash",name:"Burn to Ash",castingValue:8,phase:"Your Hero Phase",description:"CV 8. Elige una unidad enemiga o terreno de facción visible a 18\". Si el objetivo es terreno de facción, sus habilidades no tienen efecto hasta el inicio de tu siguiente turno."},
    ],
  },
];
